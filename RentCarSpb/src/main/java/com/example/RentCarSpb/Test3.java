...
public class Test3 {
    ...
    private Test3(int employee_id, String employee_name, String employee_position, String employee_dep) {
    ...
    public String toString() {
        return "Test3 [employee_id=" + employee_id + ", employee_name=" + employee_name + ", employee_position=" + employee_position + ", employee_dep=" + employee_dep + "]";
    }
}
