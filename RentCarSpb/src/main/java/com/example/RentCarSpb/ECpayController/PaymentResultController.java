    ...
    public ResponseEntity<String> handleGetRequest(@RequestParam Map<String, String> params) {
        ...
        try {
            ...
            String htmlResponse = "<html><body>" +
                    "<script>window.location.href = 'http://localhost:3000/paymentResult?MerchantTradeNo=" + merchantTradeNo + "&MerchantTradeDate=" + merchantTradeDateString + "&formid=" + formidString + "';</script>" +
                    "</body></html>";
